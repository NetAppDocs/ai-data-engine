...
summary: "ONTAP automatically updates firmware on AI Data Engine systems. You can use System Manager to disable automatic updates and view updates before they are installed."
---
...
//version compatibility matrix for ontap versions and aide versions