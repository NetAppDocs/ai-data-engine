...
summary: "You can sign in to System Manager to access the AIDE dashboard and display the cluster status. This is a good first step before beginning your AIDE administrative tasks or if you suspect an operational issue."
---
= View the AIDE storage system dashboard
:icons: font
:imagesdir: ../media/
