...
You need _storage administrator_ privileges to perform AIDE cluster node replacement tasks.

=== Restrictions

There are several restrictions to be aware of when replacing a node in your AIDE cluster:
