...
summary: "ONTAP automatically updates software and firmware on AI Data Engine systems. You can use System Manager to disable automatic updates and view updates before they are installed."
---
...
[.lead]
ONTAP automatically downloads and updates firmware, AI Data Engine Console software including vectorization and guardrails functionality, and other system files on your AI Data Engine system by default. If you want the flexibility of viewing recommended updates before they are downloaded and installed, you can use ONTAP System Manager to disable automated updates or to edit update parameters to show you notifications of available updates before any action is performed.

== Enable automatic updates

Recommended updates for storage firmware, DCN firmware, AI Data Engine Console software including vectorization and guardrails functionality, and system files are automatically downloaded and installed on your AI Data Engine system by default. If automatic updates have been disabled, you can enable them to reinstate the default behavior.
...
You can select to have recommended updates for your storage firmware, DCN firmware, AI Data Engine Console software including vectorization and guardrails functionality, and your system files automatically downloaded and installed on your cluster, or you can select to have recommended updates automatically dismissed.  If you want to manually control installation or dismissal of updates, select to be notified when a recommended update is available; then you can manually select to install or dismiss it. 
