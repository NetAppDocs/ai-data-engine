...
. In the *Add users* dialog, enter one or more usernames or groups as recognized by your OIDC provider or ONTAP.

. Select *Add*.

The new users will be able to see and use resources in this workspace from the AI Data Engine console according to their role.
