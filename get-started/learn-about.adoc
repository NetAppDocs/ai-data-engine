...
The following design characteristics define how AIDE is built to meet the needs of AI workloads:
...
. **Data collection creation**: Data engineers and data scientists use AIDE Console to query the metadata catalog, filter results, and assemble curated data collections for specific AI tasks.
