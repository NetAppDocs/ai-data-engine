...
* Centralized metadata cataloging for all data sources, including volumes stored locally on the AFX cluster and those synchronized from remote ONTAP clusters.
