...
* Scans, classifies, and categorizes data continuously across hybrid cloud environments.
...
* Searches hybrid cloud storage for relevant data using the centralized metadata catalog.
