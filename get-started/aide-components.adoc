...
* *AI data engineer*: Builds and optimizes AI/ML pipelines, manages data collections, and integrates AI models.
* *AI data scientist*: Discovers, curates, and analyzes datasets, creates data collections, and leverages retrieval endpoints for GenAI applications.
...
* link:aide-components-data-engineer.html[How AIDE data engineers work with AIDE components]
* link:aide-components-data-scientist.html[How AIDE data scientists work with AIDE components]