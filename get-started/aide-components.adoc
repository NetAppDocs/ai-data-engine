...
|Builds and optimizes AI/ML pipelines, manages data collections, and integrates AI models. This role has access to AI Data Engine Console for data engineering workflows.

| Data scientist (`data-scientist`)
|Discovers, curates, and analyzes datasets, creates data collections, and leverages retrieval endpoints for GenAI applications. This role has access to AI Data Engine Console for data science workflows.
|===
