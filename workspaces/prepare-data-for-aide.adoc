...
[.lead]
After you create a cluster, establish a data container that AI Data Engine (AIDE) can use. This data container must be an ONTAP volume, either a local volume or a volume from a peered ONTAP cluster running ONTAP 9.
...
. link:../install-setup/cluster-setup-afx.html[Select the volumes you want to use with AI Data Engine].
+
