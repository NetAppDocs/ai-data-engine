...
[.lead]
After you create a cluster, establish a data container that AIDE can use. This data container must be an ONTAP volume, either a local volume or a volume from a peered ONTAP cluster.
