...
[.lead]
After you create a cluster, you'll want to establish a data container that can be used with AI Data Engine (AIDE). This data container must be an ONTAP volume, either a local volume or a volume from a peered ONTAP cluster.
...
. link:../install-setup/cluster-setup.html#complete-the-aide-cluster-setup[Select the volumes you want to use with AI Data Engine].
+
