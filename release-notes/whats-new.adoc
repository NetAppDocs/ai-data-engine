...
.xref:../metadata-engine/index.html[Metadata engine for AI data cataloging]

The initial release includes a metadata engine that catalogs files and objects across ONTAP clusters. 

Key features include:

* Automated extraction of metadata (core and extended attributes, object tags) from local and remote ONTAP volumes from peered clusters.
...
.xref:../workspaces/index.html[Workspace management]
...
.xref:../cluster-management/index.html[Cluster setup and management]

The initial release includes these workflows:
