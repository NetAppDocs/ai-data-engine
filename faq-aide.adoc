...
No. The DCN is a NetApp-provided data compute hardware node and is the only deployment mechanism for AI Data Engine.
...
AIDE Console is a separate management interface that runs on DCNs. You use AIDE Console to manage AIDE services, such as Data Guardrails and Data Curator. You can also use ONTAP System Manager to monitor the AIDE cluster.
