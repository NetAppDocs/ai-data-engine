...
AIDE stores metadata on the connected AFX cluster. The data compute nodes use local storage for internal operations. AIDE versions and backs up metadata on a scheduled basis to ensure durability and recoverability.
