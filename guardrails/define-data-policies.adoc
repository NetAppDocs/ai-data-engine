...
* You need _storage administrator_ privileges in AIDE Console (`\https://<cluster_management_ip>/console`) to create and manage global policies. 
...
* The software license for AIDE is installed so that guardrail and inferencing features are enabled.
...
* link:../vectorization/view-data-collections.html[View data collections in AIDE]
* link:../vectorization/zero-to-rag.html[Data-to-RAG quick start for AIDE]
