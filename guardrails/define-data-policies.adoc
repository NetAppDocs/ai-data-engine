...
* The software license for AI Data Engine is installed so that guardrail and inferencing features are enabled.
...
. In AIDE Console, navigate to *Data Guardrails > Classifiers*.
...
... Choose the classifier category or classifier type for each condition.
... Add and define additional conditions as needed.
... Define specific search criteria in *Search*, then select *Accept*.
