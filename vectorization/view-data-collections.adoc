...
* You need either _storage administrator_ privileges in ONTAP System Manager or _data engineer_ or _data scientist_ privileges in AI Data Engine Console (`\https://<cluster_management_ip>/console`) to view data collections.
