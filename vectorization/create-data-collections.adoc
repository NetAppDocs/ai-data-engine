...
You'll perform all data collection tasks in AI Data Engine Console.

.Before you begin

* You need _data engineer_ or _data scientist_ privileges in AI Data Engine Console (`\https://<cluster_management_ip>/console`).
