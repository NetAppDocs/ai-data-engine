...
* You need _data engineer_ privileges in AI Data Engine Console (`https://<cluster_management_ip>/console`).
...
* link:view-data-collections.html[Observe data collections]
