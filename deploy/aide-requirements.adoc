...
+
NOTE: AIDE Lite doesn't support high availability or horizontal scale-out. If your environment consistently exceeds 3 billion files, or you require high availability and fault tolerance, deploy link:deploy-enterprise.html[AIDE Enterprise] instead.
