...
AI Data Engine also relies on NetApp Console for centralized authentication and console services. Refer to link:https://docs.netapp.com/us-en/console-setup-admin/reference-networking-saas-console.html[network access requirementsfor NetApp Console] for the endpoints required for Console and Console agent connectivity.
