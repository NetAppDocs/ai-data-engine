...
[.lead]
Review the equipment needed and the lifting precautions for your data compute nodes for AI Data Engine (AIDE).
...
+
NOTE: For information on installing the AFX 1K storage system, refer to link:https://docs.netapp.com/us-en/ontap-afx/install-setup/install-setup-workflow.html[AFX 1K storage system installation documentation^].
...
.What's next?
After you've reviewed the hardware requirements, link:prepare-hardware.html[prepare to install your data compute nodes].