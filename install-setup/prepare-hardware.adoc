...
summary: Prepare to install the data compute nodes in your ONTAP environment and register the hardware to access support benefits. 
---
...
[.lead]
Prepare to install your data compute nodes by getting the site ready, unpacking the boxes and comparing the contents of the boxes to the packing slip, and registering the system to access support benefits.
...
.What's next?
After you've prepared to install your data compute nodes, you link:deploy-hardware.html[install the data compute nodes].
