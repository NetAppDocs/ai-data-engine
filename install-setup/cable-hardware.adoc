...
* The I/O slots on an AIDE data compute node are numbered 4 and 5.
+
image::../media/temp_aide_back_slots_labeled.png[Slot numbering on an AIDE data compute node]
...
image::../media/oie_cable100_gbe_qsfp28.png[100 Gb Ethernet cable]
+
image::../media/temp_aide_network_cabling_a.png[Cable to Ethernet network]
...
image::../media/oie_cable100_gbe_qsfp28.png[100 Gb Ethernet cable]
+
image::../media/temp_aide_network_cabling_b.png[Cable to Ethernet network]
...
image::../media/oie_cable100_gbe_qsfp28.png[100 Gb Ethernet cable]
+
image::../media/temp_aide_switched_cluster_cabling_a.png[Cable to Ethernet network]
...
image::../media/oie_cable100_gbe_qsfp28.png[100 Gb Ethernet cable]
+
image::../media/temp_aide_switched_cluster_cabling_b.png[Cable to Ethernet network]
