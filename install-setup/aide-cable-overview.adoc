...
sidebar: sidebar
keywords: aide, ai, data engine, ai data engine, dcn, data compute node, afx, afx 1k, cable, overview, cisco 9332, cisco 9364, cabling, hardware, switches, storage shelves, disk shelves, controller nodes, dx50
...
image:../media/dcn-aide_cable_overview_ieops-2656.svg[AIDE system overview cabling example]
