...
keywords: shared storage cluster switch, dx50, aide, ai, data engine, ai data engine dcn, data compute node, afx, afx 1k, network requirements, cisco nexus 9332d-gx2b, cisco nexus 9364d-gx2a, switch, switches
...
---
= Network requirements for your AIDE system
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Record the required information for each network you connect to your AIDE storage system. 

== Gather network information
Before you begin the installation of your AIDE system, gather the required network information
...
.What's next?
After reviewing the network requirements, you link:cable-hardware.html[cable the controllers and storage shelves for your AIDE system].