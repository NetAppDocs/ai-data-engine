...
+
If a data compute software image is available for update, this option will be enabled. Select it to launch the data compute software update page. For more information, refer to link:../administer/update-aide-firmware-software.html[Update AI Data Engine software].
...
+
Make sure to configure OIDC for all deployments. You must configure OIDC to access AI Data Engine Console.