...
[.lead]
Review the requirements for installing AI Data Engine (AIDE). AIDE requires an AFX storage system, a minimum of three data compute nodes, network switches, and cables.

== Hardware requirements

AIDE requires an AFX storage system and a minimum of three data compute nodes. The AFX system provides the storage infrastructure, while the data compute nodes host the AIDE software components that enable data management, curation, and AI capabilities.
