...
[.lead]
After you install the rack hardware for your DX50 data compute nodes and install the cables for the controller nodes and storage shelves, you should power on your storage shelves and controller nodes.
...
== Step 1: Power on the controller nodes
