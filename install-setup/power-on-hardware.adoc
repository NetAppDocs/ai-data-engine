...
.Steps
After you've turned on your storage shelves and assigned the unique IDs, turn on the power to the storage controller nodes if they are not already powered on.
