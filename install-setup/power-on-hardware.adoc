...
---
= Power on your DX50 data compute nodes
:icons: font
:imagesdir: ../media/
...
.What's next?
After you've turned on your DX50 data compute nodes, you link:../install-setup/initialize-ontap-cluster.html[set up an ONTAP AIDE cluster].
